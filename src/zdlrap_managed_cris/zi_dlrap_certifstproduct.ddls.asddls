...
define view entity ZI_DLRAP_CERTIFSTPRODUCT
  ...
  association        to parent ZI_DLRAP_CERTIFPRODUCT as _Certif on  $projection.CertUuid = _Certif.CertUuid
  association [1..1] to ZI_DLRAP_PRODUCT              as _Prod   on  $projection.Matnr = _Prod.Matnr
